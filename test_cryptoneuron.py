# test_cryptoneuron.py
"""Tests for CryptoNeuron."""

import pytest
from cryptoneuron import CryptoNeuronCore, CryptoNeuron


class TestCore:
    def setup_method(self):
        self.core = CryptoNeuronCore(threshold=0.75)
